...
int main(int argc, char *argv[])
{
   ...
   /* TAREFA EP4: incluir as opcoes "-e" e "-t" */
	...
	else if (!strncmp(argv[argc], "-e", 2))
	else if (!strncmp(argv[argc], "-t", 2))	
